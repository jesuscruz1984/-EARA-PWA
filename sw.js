const C='eara-online-v30';
const A=['./','index.html','manifest.webmanifest','icon-192.png','icon-512.png','app.js','picture.js','picturefix.js','noise.js','handsfree.js','robot-bg.svg'];
