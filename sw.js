const C='eara-online-v33';
const A=['./','index.html','manifest.webmanifest','icon-192.png','icon-512.png','security.js','app.js','picture.js','picturefix.js','visit.js','noise.js','handsfree.js','robot-bg.svg'];
